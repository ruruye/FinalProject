               ...
               <form>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" id="status" class="form-control" value="${adminMyPageVO.codeNm}" disabled>
							</div>
							
							
							<div class="form-group col-md-6">
								<label for="stuYr">부서</label> 
								<input type="text" id="stuYr" class="form-control" value="조교" disabled>
							</div>
