            ...
            <div class="my-4">
               <form>
                  ...
                  <div class="form-row">
                     ...
                     <div class="form-group col-md-6">
                        <label for="status">재직 상태</label> 
                        <input type="text" id="status" class="form-control" value="${profMyPageVO.codeNm}" disabled>
                     </div>
                     
                     <div class="form-group col-md-6">
                        <label for="depNm">학과</label> 
                        <input type="text" id="depNm" class="form-control" value="${checkDep.depNm}" disabled>
                     </div>
                     ...
                     <div class="form-group col-md-6">
                        <label for="proPosYn">학과장 여부</label> 
                        <input type="text" id="proPosYn" class="form-control" value="${checkDep.proPosYn}" readonly>
                     </div>
                  </div>
