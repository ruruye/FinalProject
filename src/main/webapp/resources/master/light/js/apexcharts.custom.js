		...
		legend:{
			...
			var barChart,barChartoptions={
				...
				var lineChart,lineChartoptions={
					series:[{
						...
						labels:{
							...
							style:{
								colors:colors.mutedColor,
								cssClass:"text-muted",fontFamily:base.defaultFontFamily
							}
						},axisBorder:{
							show:!1
						}
				...
				var areachart,areaChartOptions={
					series:[{
							name:"Website",data:[31,28,30,51,42,109,100,31,40,28,31,58,30,51,42,109,100,116]
							},
							{
							name:"Mobile Apps",data:[11,45,20,32,34,52,41,11,32,45,11,75,20,32,34,52,41,81]
							},
							{
